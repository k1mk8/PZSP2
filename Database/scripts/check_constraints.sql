...
ALTER TABLE IF EXISTS database."PARAMETERS"
	ADD CONSTRAINT "PRM_DATA_TYPE_DEF_CHECK" CHECK ("DATA_TYPE" IN (0, 1, 2));
	
COMMENT ON CONSTRAINT "PRM_DATA_TYPE_DEF_CHECK" ON database."PARAMETERS"
	IS 'Data type def: 0 - means that the parameter value must be text, 1 - means that the parameter value must be numeric, 2 - means that the parameter value must be either 0 (false) or 1 (true)';
...
ALTER TABLE IF EXISTS database."CLINICAL_DATA_PARAMETERS_VALUES"
	ADD CONSTRAINT "CLDA_PRMVAL_SINGLE_VALUE_CHECK" CHECK (("BOOLEAN_VALUE" IS NOT NULL AND "NUMERIC_VALUE" IS NULL AND "TEXT_VALUE" IS NULL)
														  OR ("BOOLEAN_VALUE" IS NULL AND "NUMERIC_VALUE" IS NOT NULL AND "TEXT_VALUE" IS NULL)
														  OR ("BOOLEAN_VALUE" IS NULL AND "NUMERIC_VALUE" IS NULL AND "TEXT_VALUE" IS NOT NULL));

ALTER TABLE IF EXISTS database."CLINICAL_DATA_PARAMETERS_VALUES"
	ADD CONSTRAINT "CLDA_PRMVAL_BOOLEAN_VALUE_CHECK" CHECK ("BOOLEAN_VALUE" IS NULL OR "BOOLEAN_VALUE" IN (0, 1));
...
ALTER TABLE IF EXISTS database."PROCEDURES_PARAMETERS_VALUES"
	ADD CONSTRAINT "PROC_PRMVAL_SINGLE_VALUE_CHECK" CHECK (("BOOLEAN_VALUE" IS NOT NULL AND "NUMERIC_VALUE" IS NULL AND "TEXT_VALUE" IS NULL)
														  OR ("BOOLEAN_VALUE" IS NULL AND "NUMERIC_VALUE" IS NOT NULL AND "TEXT_VALUE" IS NULL)
														  OR ("BOOLEAN_VALUE" IS NULL AND "NUMERIC_VALUE" IS NULL AND "TEXT_VALUE" IS NOT NULL));

ALTER TABLE IF EXISTS database."PROCEDURES_PARAMETERS_VALUES"
	ADD CONSTRAINT "PROC_PRMVAL_BOOLEAN_VALUE_CHECK" CHECK ("BOOLEAN_VALUE" IS NULL OR "BOOLEAN_VALUE" IN (0, 1));
...
ALTER TABLE IF EXISTS database."PROCEDURE_SESSIONS_PARAMETERS_VALUES"
	ADD CONSTRAINT "PROCSES_PRMVAL_PARAMETER_TYPE_DISCR_CHECK" CHECK ("SESSION_TYPE_DISCRIMINATOR" = 'S');
	
ALTER TABLE IF EXISTS database."PROCEDURE_SESSIONS_PARAMETERS_VALUES"
ADD CONSTRAINT "PROCSES_PRMVAL_SINGLE_VALUE_CHECK" CHECK (("BOOLEAN_VALUE" IS NOT NULL AND "NUMERIC_VALUE" IS NULL AND "TEXT_VALUE" IS NULL)
													  OR ("BOOLEAN_VALUE" IS NULL AND "NUMERIC_VALUE" IS NOT NULL AND "TEXT_VALUE" IS NULL)
													  OR ("BOOLEAN_VALUE" IS NULL AND "NUMERIC_VALUE" IS NULL AND "TEXT_VALUE" IS NOT NULL));

ALTER TABLE IF EXISTS database."PROCEDURE_SESSIONS_PARAMETERS_VALUES"
	ADD CONSTRAINT "PROCSES_PRMVAL_BOOLEAN_VALUE_CHECK" CHECK ("BOOLEAN_VALUE" IS NULL OR "BOOLEAN_VALUE" IN (0, 1));
