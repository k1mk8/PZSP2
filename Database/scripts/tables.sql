...
ALTER TABLE IF EXISTS database."PATIENTS"
    ...
    REFERENCES database."CLINICAL_CENTERS" ("CLINICAL_CENTER_CODE") MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION
    NOT VALID;
...
ALTER TABLE IF EXISTS database."PATIENTS"
    ...
    REFERENCES database."PATIENTS_CLINICAL_DIAGNOSES" ("PATIENT_CODE", "DIAGNOSIS_CODE") MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION
    NOT VALID;
...
ALTER TABLE IF EXISTS database."PATIENTS_CLINICAL_DIAGNOSES"
    ...
    REFERENCES database."PATIENTS" ("PATIENT_CODE") MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION
    NOT VALID;
...
ALTER TABLE IF EXISTS database."PATIENTS_CLINICAL_DIAGNOSES"
    ...
    REFERENCES database."CLINICAL_DIAGNOSES" ("DIAGNOSIS_CODE") MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION
    NOT VALID;
...
ALTER TABLE IF EXISTS database."CLINICAL_DATA"
    ...
    REFERENCES database."DOCTORS" ("DOCTOR_CODE") MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION
    NOT VALID;
...
ALTER TABLE IF EXISTS database."PROCEDURES"
    ...
    REFERENCES database."CLINICAL_DATA" ("PATIENT_CODE", "CLINICAL_DATA_TYPE_CODE", "CLINICAL_DATA_TYPE_DISCRIMINATOR", "DATA_COLLECTION_DATE") MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION
    NOT VALID;
...
ALTER TABLE IF EXISTS database."PROCEDURES"
    ...
    REFERENCES database."PROCEDURES_COMPLETIONS_REASONS" ("REASON_CODE") MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION
    NOT VALID;
...
ALTER TABLE IF EXISTS database."PROCEDURES_PARAMETERS_VALUES"
    ...
    REFERENCES database."PROCEDURES" ("PATIENT_CODE", "PROCEDURE_TYPE_CODE", "PROCEDURE_TYPE_DISCRIMINATOR", "START_DATE") MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION
    NOT VALID;
...
ALTER TABLE IF EXISTS database."PROCEDURES_SESSIONS_PARAMETERS_VALUES"
    ...
    REFERENCES database."PROCEDURES_SESSIONS" ("PATIENT_CODE", "PROCEDURE_TYPE_CODE", "PROCEDURE_TYPE_DISCRIMINATOR", "PROCEDURE_DATE", "SESSION_TYPE_CODE", "SESSION_TYPE_DISCRIMINATOR", "ORDINAL_NUMBER") MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION
    NOT VALID;
