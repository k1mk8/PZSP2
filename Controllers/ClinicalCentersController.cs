...
namespace apka.Controllers
{
    public class ClinicalCentersController : Controller
    {
        ...
        public ClinicalCentersController(apkaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,CenterName,CenterAddress,CenterDescription")] ClinicalCenter clinicalCenter)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CenterName,CenterAddress,CenterDescription")] ClinicalCenter clinicalCenter)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'apkaContext.ClinicalCenter'  is null.");
            }
            var clinicalCenter = await _context.ClinicalCenter.FindAsync(id);
            if (clinicalCenter != null)
            {
