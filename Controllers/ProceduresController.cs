...
namespace apka2.Controllers
{
    public class ProceduresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,IsECMO,EndedOnSchedule,BloodWasReturned,ReasonOfUnplannedTermination,PatientDied,DateOfDeath,Remarks")] Procedure procedure)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,IsECMO,EndedOnSchedule,BloodWasReturned,ReasonOfUnplannedTermination,PatientDied,DateOfDeath,Remarks")] Procedure procedure)
        {
            if (id != procedure.Id)
            {
                return NotFound();
